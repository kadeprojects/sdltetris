...
# to work with the gcc version 11.1.0. You need binutils 2.32 for gcc 11.1.0.
...
### change "LDFLAGS = @LDFLAGS@" to "LDFLAGS := -s" in src/gcc-11.1.0/libstdc++-v3/Makefile.in
...
if [ ! -e "${PREFIX}/bin/liblto_plugin-0.dll" ]; then
